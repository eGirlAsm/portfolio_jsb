...
background="images/header_bg.jpg" border=0>
  <TR height=56>
    ...
    <TD style="FONT-WEIGHT: bold; COLOR: #fff; PADDING-TOP: 20px"
      align=middle>当前用户：<?php echo $r[username];?> &nbsp;&nbsp; <A style="COLOR: #fff"
      href="admin_user_edit.php?id=<?php echo $uid?>"
      target=main>修改口令</A> &nbsp;&nbsp; <A style="COLOR: #fff"
      onclick="if (confirm('确定要退出吗？')) return true; else return false;"
      href="admin_main.php?action=logout" target=_parent>退出系统</A>
    </TD>
