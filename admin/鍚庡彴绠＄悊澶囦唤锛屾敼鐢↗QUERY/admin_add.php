...
if(isset($_POST[into_nav])){
	...
	$query1=mysql_query("SELECT COUNT(*) FROM 'p_admin'");

    $db->query("INSERT INTO `p_admin`(`uid`, `m_id`, `username`, `password`,'name') VALUES (NULL,'$query1','$_POST[username]',md5($_POST[password]),'$_POST[name]')");
	$db->Get_admin_msg("admin_user_list.php","添加成功");
}
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
  <TR height=28>
    <TD background=images/title_bg1.jpg>当前位置: 系统设置-管理员添加</TD>
  </TR>
  <TR>
