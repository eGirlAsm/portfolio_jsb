...
n[0] = new Array("0");
     ...
     n[5] = new Array("0","54342","54662","54453","54338","54346","54353","54249","54347","54471","54237","54324","54337","54497","54339");
     n[6] = new Array("0","53463","99999","54102","53446","54218","50527","53512","53543","54135");
     ...
     n[10] = new Array("0","53772","53782","53976","53778","53868","53959","53882","53578","53674","53487","53753");
     ...
     n[18] = new Array("0","57687","57766","57662","57972","57649","57780","57763","57773","57674","57866","57584","57872","57749","57771","57558");
...
function MM_jumpMenu(targ,selObj,restore){ //v3.0
    eval(targ+".location='weather.php?citycode="+selObj.options[selObj.selectedIndex].value+"'");
    if (restore) selObj.selectedIndex=0;
}
function setcity(c) {
	var date=new Date();
	if(document.getElementById('setcity').innerHTML == '定制该城市天气') {
	    date.setTime(date.getTime+3600*24*30);
	    cookiestring = "citycode="+c+"; expire="+date.toGMTString()+"; path=/";	
	    document.getElementById('setcity').innerHTML = '取消该城市天气定制';
	    alert('您已经成功定制该城市天气信息！');	
	} else {
		date.setTime(date.getTime);
	    cookiestring = "citycode=; expire="+date.toGMTString()+"; path=/";
	    document.getElementById('setcity').innerHTML = '定制该城市天气';
	    alert('您已经成功取消该城市天气信息定制！');
	}
